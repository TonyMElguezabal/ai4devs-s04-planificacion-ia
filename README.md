...
- [ ] Haber consumido el material asíncrono de la S4 (páginas 1-7), en especial la página 2 (anatomía de un backlog AI-ready) y el patrón "AI as poke-holes".
...
**¿Tengo que crear los issues en Linear ahora?**
No. Eso es lo que haremos en la Demo 1, conectando Claude Code al MCP de Linear. El ejercicio pre-sesión es solo el output local en markdown.

**¿Y si la IA me genera 30 stories?**
Si genera muchas, está sobre-descomponiendo (granularidad muy fina). Refina tu prompt para que se quede en 8-12 stories realmente del MVP. Si no consigues bajar el número, tráelo a la sesión y lo discutimos — es un caso interesante.

**¿Y si no encuentro nada en el patrón poke-holes?**
Significa una de dos cosas: (a) la IA generó stories tan vagas que no hay nada concreto que criticar — problema del prompt original; o (b) estás aceptando los AC de la IA como correctos sin verificar contra el PRD — problema de revisión crítica. Reescribe el prompt o relee el PRD con detalle. Las stories que cubren más del 70% del PRD **siempre** tienen al menos 3 gaps; las que parecen perfectas suelen estar inventando.

**¿Qué modelo me recomiendas?**
Cualquiera de Claude (Sonnet 4.6, Opus 4.6), GPT-5 o Gemini 2.5 funciona bien. Si quieres seguir el patrón de la sesión, usa Claude Code con Sonnet u Opus — es lo que usaremos en la demo.

**¿Puedo trabajar en parejas?**
Sí. Si trabajáis en pareja, entregad uno de los dos con el output completo, y el otro con una breve nota apuntando a la rama del compañero.

**¿Debo pulir el output de la IA antes de entregar?**
No. Entrega el output crudo. La gracia del ejercicio está en analizar lo que la IA produjo sin tu intervención, incluyendo sus errores.

---

## Por qué este ejercicio

En el directo de la S4 trabajamos planificación asistida por IA aplicada a FlowSync. La calidad de la sesión depende directamente de la calidad del material que traes.

Si llegas sin haber generado tu backlog, la Demo 1 pierde su anclaje: no hay sobre qué comparar prompts ni qué hallazgos discutir. Y el patrón "AI as poke-holes" solo se entiende de verdad cuando lo has ejecutado con tus manos sobre un PRD real, no leyéndolo.

Tu trabajo previo es la entrada. La sesión en vivo es el aterrizaje en herramientas reales y patrones operativos.
